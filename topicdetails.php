...
<body>
	...
	<div class="section-headline-wrap">
		<div class="section-headline">
			<h2></h2>
			<p>Home<span class="separator">/</span>Accounting<span class="separator">/</span><span class="current-section">Topic Details</span></p>
		</div>
	</div>
	<!-- /SECTION HEADLINE -->
<?php 
$did=intval($_GET['topicid']);
$sql = "SELECT pid,topic,description,price,statement_of_problem,aim_objectives,format,chapters,pages,attribute,studylevel from tblaccounting WHERE pid=:did";
$query = $dbh -> prepare($sql);
		...
		<div class="section">
			...
			<div class="sidebar right">
				...
				<div class="sidebar-item">
					...
					<a href="payment.php?topicid=<?php echo htmlentities($result->pid);?>" class="button mid dark spaced"><span class="primary">Get Full Access Now!</span></a>
...
?>   
				...
				<div class="sidebar-item author-bio">
					...
					<!-- /SHARE LINKS -->
					<a href="#" class="button mid dark spaced">Share Our <span class="primary">Social Media Page</span></a>
			...
			<div class="content left">
				...
				<article class="post">
					...
					<div class="post-content">
						...
						<!-- POST PARAGRAPH -->
						<div class="post-paragraph">
							<h3 class="post-title small">Chapter One</h3>
							<h3 class="post-title small">INTRODUCTION</h3>
							<h3 class="post-title small">1.1 Background of the Study</h3>
							<p><?php echo htmlentities($result->description);?></p>
							<h3 class="post-title small">1.2 Statement of  Problem</h3>
							<p><?php echo htmlentities($result->statement_of_problem);?></p>
							<h3 class="post-title small">1.3 Aim and Objectives of the Study</h3>
							<p><?php echo htmlentities($result->aim_objectives);?></p>
							
							<a href="payment.php?topicid=<?php echo htmlentities($result->pid);?>" class="button mid primary half">Get Full Access Now!</a>
